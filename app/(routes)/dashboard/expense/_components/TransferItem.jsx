...
function TransferItem({ id, totalCash, totalSpend }) {
  ...
  return (
    <Link href={`/dashboard/expense/${id}`}>
      <div className="p-5 border rounded-2xl hover:shadow-md cursor-pointer h-[170px]">
        <div className="flex gap-2 items-center justify-between">
          ...
          <h2 className="font-bold text-primary text-lg">${formatNumber(totalCash - totalSpend)}</h2>
        </div>
